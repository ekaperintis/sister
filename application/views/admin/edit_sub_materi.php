      ...
      <div class="content-wrapper">
        <!-- Content Header (Page header) -->
          <section class="content-header">
            <h1>
              Edit
              <small>Sub Materi</small>
            </h1>
            <ol class="breadcrumb">
              <li><i class="fa fa-dashboard"></i> Home</a></li>
              <li><a href="<?php echo base_url(); ?>admin/materi">Sub Materi</a></li>
          ...
          <section class="content">
            <div class="box box-info">
              ...
              <div class="box-body">
                <!-- form start -->
                <?php echo form_open_multipart('admin/update_sub_materi'); ?>
                ...
                <div class="form-group" style="position:relative;"> Photo
                    ...
                    &nbsp;
                    <span class='label label-info' id="upload-file-info"><?php echo $data->photo; ?></span>

                </div>

                  <div class="form-group">
                    <label for="exampleInputEmail1">Deskripsi</label>
                      <input type="text" class="form-control" name="deskripsi" value="<?php echo $data->deskripsi; ?>" required="true" />
                  </div>

                  <div class="form-group">
                    <label for="exampleInputEmail1">Fitur</label>
                      <input type="text" class="form-control" name="fitur" placeholder="Fitur" required="true" value="<?php echo $data->fitur; ?>"/>
                  </div>

                  <div class="form-group">
                    <label for="exampleInputEmail1">Benefit</label>
                      <input type="text" class="form-control" name="benefit" placeholder="Benefit" required="true" value="<?php echo $data->benefit; ?>"/>
                  </div>

                  <div class="form-group">
                    <label for="exampleInputEmail1">Kegunaan</label>
                      <input type="text" class="form-control" name="kegunaan" placeholder="Kegunaan" required="true" value="<?php echo $data->kegunaan; ?>"/>
                  </div>

                  <input type="hidden" name="id" value="<?php echo $data->kdsubmateri ?>">
