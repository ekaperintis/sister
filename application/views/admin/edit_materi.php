        ...
        <!-- Content Header (Page header) -->
          ...
          <section class="content">
            <div class="box box-info">
              ...
              <div class="box-body">
                <!-- form start -->
                <?php echo form_open('admin/update_materi'); ?>
                ...
                ?>
                  <div class="form-group">
                    <label for="exampleInputEmail1">Nama Materi</label>
                      <input type="text" class="form-control" name="nama_materi" value="<?php echo $data->nmmateri; ?>" required="true" />
                  </div>

                  <input type="hidden" name="id" value="<?php echo $data->kdmateri ?>">
