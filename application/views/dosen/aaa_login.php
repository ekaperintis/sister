...
<head>
<meta charset="utf-8">
<title><?php echo $this->config->item('nama_aplikasi')." versi ".$this->config->item('versi');?></title>
...
<div class="container">
	...
	<form action="" method="post" name="fl" id="f_login" onsubmit="return login();">
		...
		<div class="top110">
			<br />
			<center><img src="<?php echo base_url('photo/logo.png')?>"></center>
			<br />
			<div class="panel">
				<br />
			<div class="panel-body">
				...
				<div class="login-actions">
					<button class="button btn btn-danger btn-large col-lg-12 top15">Login</button>
				</div> <!-- .actions -->
			</div>
			<br />
		</div>
